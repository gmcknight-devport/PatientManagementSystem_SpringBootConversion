...
/**
 * Entity class for PatientMessage. 
 * Concrete implementation of IMessage and corresponds to a database table. 
 * Contains all information about each patient message with each variable having 
 * validation annotations.
 * @author Glenn McKnight
 *
 */
@Entity
public class PatientMessage implements IMessage {
	...
	public PatientMessage(Long id, String userId, String senderId, String senderName, LocalDateTime sentAt,
			String message) {
		this.id = id;
		this.userId = userId;
