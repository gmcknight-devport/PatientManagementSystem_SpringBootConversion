...
/**
 * Entity class for DoctorMessage. 
 * Concrete implementation of IMessage and corresponds to a database table. 
 * Contains all information about each doctor message with each variable having 
 * validation annotations.
 * @author Glenn McKnight
 *
 */
@Entity
public class DoctorMessage implements IMessage {
	...
	public DoctorMessage(Long id, String userId, String senderId, String senderName, LocalDateTime sentAt,
			String message) {
		this.id = id;
		this.userId = userId;
